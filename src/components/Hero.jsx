        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          >
            <div className="retro-card p-5 sm:p-6 flex-1 flex flex-col justify-between relative group">
              ...
              <div className="relative my-4 w-full max-w-[360px] sm:max-w-[420px] lg:max-w-[450px] aspect-square mx-auto flex items-center justify-center">
                ...
                {/* Single Main Avatar Circle (Split Red/Salmon Background + Sparkles) */}
                <div className="relative w-full h-full rounded-full overflow-hidden border-3 sm:border-4 border-[var(--color-border)] shadow-[6px_6px_0px_var(--color-border)]">
